...
В данном случае также нужно подрезание чтений с использованием trimmomatic
...
при расчете пересечения число участков, имеющихся в первом файле, присутствуют и во втором файле (и наоборот). Такое маленькое количество пересечений связано с тем, что выравнивание производится лишь на одну хромосому, а не на все (как в ENCODE).
