...
Наличие различий в количестве пересечений объясняется тем, что мы в начале считаем число пиков в первом файле, которые есть и во втором файле. Получается,когда мы меняем файлы местами, то у нас появляются различия в количестве пересечений. 
